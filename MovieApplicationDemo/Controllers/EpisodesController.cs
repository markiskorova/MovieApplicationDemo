...
namespace MovieApplicationDemo.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class EpisodesController : ControllerBase
    {
        private readonly MovieApplicationDemoContext _context;

        public EpisodesController(MovieApplicationDemoContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Episode>> PostEpisode(Episode episode)
        {
            if (_context.Episode == null)
            {
                return Problem("Entity set 'MovieApplicationDemoContext.Episode'  is null.");
            }
